...
class PemerintahLahanExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithTitle
{
    protected $filters;
    ...
    {
        $query = LahanData::with(['bulan', 'wilayah', 'variabel.topik', 'klasifikasi']);
