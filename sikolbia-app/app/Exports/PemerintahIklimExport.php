...
class PemerintahIklimExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithTitle
{
    protected $filters;
    ...
    {
        $query = IklimoptdpiData::with(['bulan', 'wilayah', 'variabel.topik', 'klasifikasi']);
