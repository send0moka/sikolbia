...
# Formula FIXED: (bahan_makanan_ribu_ton × 1,000 × 1,000,000 kg) / (populasi × 30.4375)
# Note: bahan_makanan is MONTHLY (already divided by 12 in seeder)
...
print(f"✓ Target variable created (MONTHLY data: bahan_makanan / (populasi × 30.4375 days))")
...
# Export full dataset
output_path = '/app/ml_models/data/nbm_processed.csv'
...
train_df.to_csv('/app/ml_models/data/nbm_train.csv', index=False)
val_df.to_csv('/app/ml_models/data/nbm_val.csv', index=False)
test_df.to_csv('/app/ml_models/data/nbm_test.csv', index=False)
