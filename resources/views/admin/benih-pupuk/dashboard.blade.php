            ...
            <div class="bg-white dark:!bg-neutral-800 overflow-hidden shadow-lg rounded-lg border border-neutral-200 dark:border-neutral-700">
                <div class="p-4 lg:p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-neutral-900 dark:text-white">Total Alamat</h3>
                            <p class="text-2xl font-semibold text-neutral-900 dark:text-white">1,248</p>
                            <p class="text-sm text-neutral-500 dark:text-neutral-400">+12% dari bulan lalu</p>
                        </div>
                    </div>
                </div>
            </div>

            <!-- Alamat Baru Bulan Ini -->
            <div class="bg-white dark:!bg-neutral-800 overflow-hidden shadow-lg rounded-lg border border-neutral-200 dark:border-neutral-700">
                <div class="p-4 lg:p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-neutral-900 dark:text-white">Alamat Baru</h3>
                            <p class="text-2xl font-semibold text-neutral-900 dark:text-white">124</p>
                            <p class="text-sm text-neutral-500 dark:text-neutral-400">Bulan ini</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:!bg-neutral-800 overflow-hidden shadow-lg rounded-lg border border-neutral-200 dark:border-neutral-700">
                <div class="p-4 lg:p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-neutral-900 dark:text-white">Tervalidasi</h3>
                            <p class="text-2xl font-semibold text-neutral-900 dark:text-white">1,024</p>
                            <p class="text-sm text-neutral-500 dark:text-neutral-400">82% dari total</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:!bg-neutral-800 overflow-hidden shadow-lg rounded-lg border border-neutral-200 dark:border-neutral-700">
                <div class="p-4 lg:p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-neutral-900 dark:text-white">Kategori Alamat</h3>
                            <p class="text-2xl font-semibold text-neutral-900 dark:text-white">8</p>
                            <p class="text-sm text-neutral-500 dark:text-neutral-400">Kategori aktif</p>
                        </div>
                    </div>
                </div>
            </div>
