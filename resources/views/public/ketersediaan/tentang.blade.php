            ...
            <div class="max-w-7xl mx-auto">
                    ...
                    <div class="flex items-start gap-6">
                        ...
                        <div>
                            ...
                            <div class="prose prose-lg text-gray-700">
                                <p class="mb-4">
                                    <strong>Neraca Bahan Makanan (NBM)</strong> adalah sistem akuntansi yang
                                    menggambarkan
                                    situasi ketersediaan dan kebutuhan pangan di suatu negara atau wilayah pada periode
                                    waktu tertentu.
                                    NBM memberikan informasi komprehensif tentang aliran komoditas pangan mulai dari
                                    produksi,
                        ...
                        <div class="border-l-4 border-green-500 pl-6">
                            ...
                            <ul class="space-y-2 text-gray-700">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span><strong>Impor:</strong> Komoditas pangan yang didatangkan dari luar
                                        negeri</span>
                                </li>
                                <li class="flex items-start">
                        ...
                        <div class="border-l-4 border-red-500 pl-6">
                            ...
                            <ul class="space-y-2 text-gray-700">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span><strong>Penggunaan Lain:</strong> Untuk industri, pakan ternak, bibit,
                                        dll</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-trash text-red-600 mr-2 mt-1 text-sm"></i>
                                    <span><strong>Susut:</strong> Kehilangan dalam proses penyimpanan dan
                                        distribusi</span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-gray-600 text-sm">
                                Memberikan data untuk merumuskan kebijakan ketahanan pangan dan strategi pembangunan
                                pertanian
                            </p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-8 mb-8 border border-green-200">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                        <div>
                            <div class="text-3xl font-bold text-green-800">{{ $stats['total_kelompok'] }}</div>
                            <div class="text-sm text-gray-600">Kelompok Komoditas</div>
                        </div>
                        <div>
                            <div class="text-3xl font-bold text-green-800">{{ $stats['total_komoditas'] }}</div>
                            <div class="text-sm text-gray-600">Komoditas Pangan</div>
                        </div>
                        <div>
                            <div class="text-3xl font-bold text-green-800">{{ $stats['total_tahun'] }}</div>
                            <div class="text-sm text-gray-600">Tahun Data
                                ({{ $stats['tahun_awal'] }}-{{ $stats['tahun_akhir'] }})</div>
                        </div>
                        <div>
                            <div class="text-3xl font-bold text-green-800">
                                {{ number_format($stats['total_transaksi']) }}</div>
                            <div class="text-sm text-gray-600">Total Record Data</div>
                        </div>
                    </div>

                    <!-- Additional Stats Row -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-center mt-6 pt-6 border-t border-green-200">
                        <div>
                            <div class="text-2xl font-bold text-blue-800">{{ $stats['bulan_terakhir'] }}</div>
                            <div class="text-sm text-gray-600">Bulan Data Terkini ({{ $stats['tahun_akhir'] }})</div>
                        </div>
                        <div>
                            <div class="text-2xl font-bold text-blue-800">
                                {{ number_format($stats['total_konsumsi_ton'], 0) }}</div>
                            <div class="text-sm text-gray-600">Total Konsumsi Nasional (ton/tahun)</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-8 mb-8">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">
                        ...
                        {{ $stats['total_kelompok'] }} Kelompok Komoditas dalam NBM
                    </h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        @foreach($kelompokList as $kelompok)
                        <div class="flex items-center p-4 border border-gray-200 rounded-lg">
                            <div class="w-10 h-10 bg-{{ $kelompok['color'] }}-100 rounded-full flex items-center justify-center mr-3">
                                <i class="{{ $kelompok['icon'] }} text-{{ $kelompok['color'] }}-600"></i>
                            </div>
                            <span class="font-medium text-gray-800">{{ $kelompok['nama'] }}</span>
                        </div>
                        @endforeach
                    </div>
                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <span class="text-sm text-gray-600">Prediksi konsumsi berdasarkan pola
                                                historis</span>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <span class="text-sm text-gray-600">Interpretabilitas faktor yang
                                                mempengaruhi prediksi</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
