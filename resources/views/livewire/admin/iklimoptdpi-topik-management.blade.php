<div>
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-semibold text-neutral-900 dark:text-white">Kelola Topik Iklim Opt DPI</h1>
                <p class="mt-1 text-sm text-neutral-600 dark:text-neutral-400">
                    Kelola data topik iklim optimalisasi DPI
                </p>
            </div>
            <flux:button wire:click="openCreateModal" variant="primary">
                Tambah Topik Iklim Opt DPI
            </flux:button>
        </div>
    </div>
    ...
    <div class="mb-4 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div class="flex flex-col sm:flex-row sm:items-center gap-3 flex-1">
            <flux:input 
                ...
                placeholder="Cari topik iklim opt dpi..."
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-4 text-center text-neutral-500 dark:text-neutral-400">
                            Tidak ada topik iklim opt dpi ditemukan
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div class="fixed inset-0 bg-neutral-900/70 dark:bg-neutral-950/80 backdrop-blur-sm overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border border-neutral-200 dark:border-neutral-700 w-96 shadow-xl rounded-md bg-white dark:!bg-neutral-800">
            <div class="mt-3">
                <h3 class="text-lg font-medium text-neutral-900 dark:text-white mb-4">Tambah Topik Iklim Opt DPI</h3>
                <form wire:submit="createTopik">
                    <div class="space-y-4">
                        <flux:input wire:model="nama" label="Nama Topik" placeholder="Masukkan nama topik" required />
    ...
    <div class="fixed inset-0 bg-neutral-900/70 dark:bg-neutral-950/80 backdrop-blur-sm overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border border-neutral-200 dark:border-neutral-700 w-96 shadow-xl rounded-md bg-white dark:!bg-neutral-800">
            <div class="mt-3">
                <h3 class="text-lg font-medium text-neutral-900 dark:text-white mb-4">Edit Topik Iklim Opt DPI</h3>
    ...
    <div class="fixed inset-0 bg-neutral-900/70 dark:bg-neutral-950/80 backdrop-blur-sm overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border border-neutral-200 dark:border-neutral-700 w-96 shadow-xl rounded-md bg-white dark:!bg-neutral-800">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg font-medium text-neutral-900 dark:text-white mt-2">Hapus Topik Iklim Opt DPI</h3>
                <div class="mt-2">
                    <p class="text-sm text-neutral-500 dark:text-neutral-400">
                        Apakah Anda yakin ingin menghapus topik <strong>{{ $deletingTopik->nama ?? '' }}</strong>?
