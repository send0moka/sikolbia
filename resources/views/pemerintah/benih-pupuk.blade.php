<x-layouts.pemerintah title="Benih & Pupuk - Panel Pemerintah - {{ config('app.name') }}">
    <div class="container mx-auto px-4 py-8">
        <div class="mb-6">
            <flux:heading size="xl">Data Benih & Pupuk</flux:heading>
            <flux:subheading>Informasi Sarana Produksi Pertanian</flux:subheading>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <flux:card>
                <flux:heading size="lg" class="mb-4">Data Benih</flux:heading>
                <div class="space-y-4">
                    <div class="flex items-center p-3 bg-neutral-50 dark:bg-neutral-800 rounded-lg">
            ...
            <flux:card>
                <flux:heading size="lg" class="mb-4">Data Pupuk</flux:heading>
                <div class="space-y-4">
                    <div class="flex items-center p-3 bg-neutral-50 dark:bg-neutral-800 rounded-lg">
